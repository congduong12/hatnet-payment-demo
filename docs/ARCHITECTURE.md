...
The accepted application stack is NestJS backend plus React frontend. See
`docs/decisions/0006-application-stack.md`.

No application code exists yet. This document defines generic architecture
questions and boundary rules that implementation should adapt as selected
stories enter execution.

Before implementing NestJS persistence code, read
`docs/templates/inp-base-repository-agent-guide.md`.
