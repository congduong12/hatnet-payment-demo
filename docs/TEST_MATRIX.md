...
| US-006 | Checkout and currency foundation: immutable order snapshots, integer-safe USD-to-VND conversion, rounding, transactional cart close | no | no | no | no | planned | Awaiting high-risk implementation approval; public `POST /checkout`, points, payOS, and browser UI deferred; `docs/stories/high-risk/US-006-checkout-currency-foundation/` |
